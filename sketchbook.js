...
(function () {
    ...
    function buildCard(work, opts) {
        ...
        // On the card element, beside the flip button rather than inside it (a
        // link in a button is not one every browser will click), which is where
    ...
    var LINK_SVG = '<svg viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">'
    ...
    function buildLink(work) {
        ...
        a.setAttribute('aria-label', work.title + ' link (opens in a new tab)');
